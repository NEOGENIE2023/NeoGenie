...
class _BottomBarState extends State<BottomBar> {
  ...
  Widget cusSearchBar = Text(numbersend());
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        items: const [
          ...
          Icon(
            FluentSystemIcons.ic_fluent_data_usage_regular,
            color: Colors.white,
            semanticLabel: "History",
          ),
          Icon(
            FluentSystemIcons.ic_fluent_data_treemap_regular,
            color: Colors.white,
