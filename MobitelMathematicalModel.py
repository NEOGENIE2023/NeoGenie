...
YouTube360Package = -1 * (Whatsapp + Facebook + Youtube + Tiktok + Instagram + Telegram + Other)
if YouTube360Package >= 0:
  YouTube360Package += 360
...
if Mobitel_Unlimited_Messaging_Package >= 0:
  Mobitel_Unlimited_Messaging_Package += 70
...
if Mobitel_Social_Networking_Unlimited >= 0:
  Mobitel_Social_Networking_Unlimited += 145

# For Mobitel GINI Nonstop Lokka
Mobitel_GINI_Nonstop_Lokka = -1 * (Tiktok + Telegram + Other)
if Mobitel_GINI_Nonstop_Lokka >= 0:
  Mobitel_GINI_Nonstop_Lokka += 520

# For Mobitel Tripple Buddy
Mobitel_Tripple_Buddy = P6 * (1.00 - (Whatsapp + Facebook + Youtube + Tiktok +Instagram + Telegram + Other) / A6A)
